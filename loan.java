...
public class LogRegression {
	...
	public static void main(String args[]) {
		...
		try {
			Table bank_data = Table.read().csv("C:\Sweety\train.csv");
			...
			Instances train_data = getInstances("C:\Sweety\train.csv.arff");
			Instances test_data = getInstances("C:\Sweety\test.csv.arff");
